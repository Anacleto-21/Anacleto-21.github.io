...
gdjs.evtsExt__Enemy__IsFlyDead.conditionTrue_0 = {val:false};
gdjs.evtsExt__Enemy__IsFlyDead.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__Enemy__IsFlyDead.condition1IsTrue_0 = {val:false};
...
for(var i = 0, k = 0, l = gdjs.evtsExt__Enemy__IsFlyDead.GDFlyObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Enemy__IsFlyDead.GDFlyObjects1[i].getVariableBoolean(gdjs.evtsExt__Enemy__IsFlyDead.GDFlyObjects1[i].getVariables().get("Dead"), true) ) {
        gdjs.evtsExt__Enemy__IsFlyDead.condition0IsTrue_0.val = true;
        gdjs.evtsExt__Enemy__IsFlyDead.GDFlyObjects1[k] = gdjs.evtsExt__Enemy__IsFlyDead.GDFlyObjects1[i];
        ++k;
    }
}
gdjs.evtsExt__Enemy__IsFlyDead.GDFlyObjects1.length = k;}if (gdjs.evtsExt__Enemy__IsFlyDead.condition0IsTrue_0.val) {
